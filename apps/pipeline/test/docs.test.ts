...
describe("application documentation", () => {
  ...
  test("publishes the executable workspace verification commands", async () => {
    const html = await readFile(resolve(repositoryRoot, "docs/apps/index.html"), "utf8");
    for (const command of [
      ...
      "cd apps &amp;&amp; bun run --cwd pipeline context:sync",
      "cd apps &amp;&amp; bun run --cwd pipeline doctor",
    ]) {
